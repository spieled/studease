define("gallery/jquery.spell/1.0.0/jquery.spell", ["$"], function (require, exports, module) {

    var $ = require("$");

    $.fn.spell = function (lowcase, full) {
        ...
        $.fn.spell = function (lowcase, full) {
            ...
            this.each(function () {
                ...
                var pp = [
                    ...
                    ['Ju', '鞠拘狙疽居驹菊局咀矩举沮聚拒据巨具距踞锯俱句惧炬剧倨讵苣苴莒掬遽屦琚椐焗榘榉橘犋飓钜锔窭裾醵踽龃雎鞫'],
                    ...
                    ['Qi', '期欺栖戚妻七凄漆柒沏其棋奇歧畦崎脐齐旗祈祁骑起岂乞企启契砌器气迄弃汽泣讫亓圻芑芪萁萋葺蕲嘁屺岐汔淇骐绮琪琦杞桤槭耆祺憩碛颀蛴蜞綦碁鳍麒'],
                    ['Qia', '掐恰洽葜袷髂'],
                    ...
                    ['Yi', '一壹医揖铱依伊衣颐夷遗移仪胰疑沂宜姨彝椅蚁倚已乙矣以艺抑易邑屹亿役臆逸肄疫亦裔意毅忆义益溢诣议谊译异翼翌绎刈劓佚佾诒圯埸懿苡荑薏弈奕挹弋呓祎咦咿噫峄嶷猗饴怿怡悒漪迤驿缢殪轶贻欹旖熠眙钇镒镱痍瘗癔翊蜴舣羿'],
